...
First, install the dependencies of the frontend project.
...
You can build this project using npm commands on the root of the project that will redirect commands to the subprojects inside this monorepo.
